...
public class CrmProTestCase {
	    ...
	    public static void main(String[] args) throws InterruptedException {
		    ...
		    WebElement dDown = driver.findElement(By.cssSelector("[name='status']"));
             ...
             WebElement drOP = driver.findElement(By.cssSelector("[name='source']"));  
		     Select sELE = new Select(drOP);
		     sELE.selectByValue("Call in");
		     
		     driver.findElement(By.cssSelector("[name='address_title']")).sendKeys("xyz");
		     driver.quit();	     
	    }
}
